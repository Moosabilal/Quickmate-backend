import {
  type ICategoryFormCombinedData,
  type ICategoryInput,
  type ICategoryResponse,
  type ICategoryWithDetails,
  type ICommissionRuleInput,
...
export class CategoryService implements ICategoryService {
  ...
  async createCategory(
    ...
    commissionRule?: ICommissionRuleResponse;
  }> {
    ...
    const createdCommissionRule = newRule.toJSON() as unknown as ICommissionRuleResponse;
  ...
  public async getCommissionSummary(): Promise<ICommissionSummary> {
    ...
    const avgCommissionPrevious =
      previousBookingsCount > 0 ? previousPayments.totalCommission / previousBookingsCount : 0;
    ...
    return {
      ...
      commissionDeductionsToProvidersChange: calculateChange(
        currentPayments.totalProviderAmount,
        previousPayments.totalProviderAmount,
      ),
    };
  }
