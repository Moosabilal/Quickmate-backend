...
export interface IAuthService {
  ...
  login(email: string, password: string): Promise<{ user: { id: string; name: string; email: string; role: string, isVerified: boolean; profilePicture: string; googleCalendar?: {tokens?: Credentials} }; token: string; refreshToken: string }>;
  ...
  getUser(token: string): Promise<{ id: string; name: string; email: string; role: string, isVerified: boolean, profilePicture?: string, googleCalendar?: {tokens?: Credentials} }>;
