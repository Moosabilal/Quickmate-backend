...
export interface IBookingService {
    ...
    getAllFilteredBookings(userId: string, filters: { search?: string, status?: BookingStatus }): Promise<IUserBookingsResponse>; updateStatus(bookingId: string, status: BookingStatus, userId?: string): Promise<{ message: string, completionToken?: string }>;
    ...
    saveAndEmitMessage(io: any, messageData: ISocketMessage): Promise<IMessage>;
