...
let SubscriptionPlanController = class SubscriptionPlanController {
    ...
    getSubscriptionPlan = async (req, res, next) => {
        try {
    ...
    checkProviderSubscription = async (req, res, next) => {
        try {
    ...
    calculateUpgrade = async (req, res, next) => {
        try {
    ...
    scheduleDowngrade = async (req, res, next) => {
        try {
    ...
    cancelDowngrade = async (req, res, next) => {
        try {
            const userId = req.user.id;
...
SubscriptionPlanController = __decorate([
    injectable(),
    __param(0, inject(TYPES.SubscriptionPlanService)),
